...
class DoctorCalendarViewController: UIViewController {
    ...
    var schedules: [Schedule] {
        get {
            ...
            self.tableView.isHidden = data.count > 0 ? false : true
            return data.sorted()
        }
    }
...
// MARK: Helpers
extension DoctorCalendarViewController {
...
extension DoctorCalendarViewController {
    func configureCell(view: JTAppleCell?, cellState: CellState) {
        ...
        myCustomCell.selectedView.backgroundColor = UIColor.init(red: 63.0/255.0, green: 153.0/255.0, blue: 159.0/255.0, alpha: 1.0)
...
extension DoctorCalendarViewController : UITableViewDataSource {
...
extension DoctorCalendarViewController : UITableViewDelegate {

...
class CurrencyCell: UITableViewCell {
    ...
    var currency:Currency?{
        didSet{
            ...
            let curString = NSMutableAttributedString(string: "\(currency!.currencyCode!) - \(currency!.currencyName!)", attributes: [NSAttributedStringKey.foregroundColor: UIColor.gray])
